    ...
    <div>
      <div className="rounded-md border-2 border-border/80 w-full overflow-hidden h-fit">
        ...
        <div className="p-3 flex flex-col justify-center items-center w-full h-full">
          <p className="font-bold text-lg text-center capitalize line-clamp-2">{legislator.fname} {legislator.lname}</p>
          <p className="italic text-secondary text-center capitalize line-clamp-1">{legislator.constituency} <span>({legislator.party})</span></p>
